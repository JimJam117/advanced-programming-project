...
let rec inpLoop (symTList:List<string*int>) = 
    ...
    if input <> "" then
        ...
        consoleOutput += "Variable name = " + tempID.ToString()    // UPDATE
        consoleOutput += "Result = {0}" + tempVal.ToString()          // UPDATED
